...
export const I18n = new LocalizedStrings({
    zh:{
        ...
        submit: "提交",
        // Ticket notice items
        ticketNotice1: "所有车票只限票面上注明之日期及班次有效，乘客必须依照选定的日期及上车地点登车，过期无效。",
        ticketNotice2: "乘客必须按车票上注明之班次于开车前15分钟到达上车点候车，逾时不候，亦不获退票。",
        ticketNotice3: "儿童车票只适合3-5岁小童使用。",
        ticketNotice4: "如需办理预办登机手续，平日请于航班起飞前3小时到达本公司票务中心办理手续；而节日或周末前夕请于航班起飞前4小时到达本公司票务中心办理手续。",
        ticketNotice5: "香港市区与深圳宝安机场间之车程约为2小时「不包括特殊路面交通情况及过关等候时间」。",
    ...
    hk:{
        ...
        submit: "提交",
        // Ticket notice items
        ticketNotice1: "所有車票只限票面上註明之日期及班次有效，乘客必須依照選定的日期及上車地點登車，過期無效。",
        ticketNotice2: "乘客必須按車票上註明之班次於開車前15分鐘到達上車點候車，逾時不候，亦不獲退票。",
        ticketNotice3: "兒童車票只適合3-5歲小童使用。",
        ticketNotice4: "如需辦理預辦登機手續，平日請於航班起飛前3小時到達本公司票務中心辦理手續；而節日或週末前夕請於航班起飛前4小時到達本公司票務中心辦理手續。",
        ticketNotice5: "香港市區與深圳寶安機場間之車程約為2小時「不包括特殊路面交通情況及過關等候時間」。",
